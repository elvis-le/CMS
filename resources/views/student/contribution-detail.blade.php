...
<div class="container-contribution">
    ...
    <form action="{{ route('st.edit-contribution') }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="contribution-view-wrap  contribution-form-wrap">
            ...
            <div class="contribution-btn-wrap">
                ...
                @else
                <p>The deadline for editing has expired</p>
                <div class="btn-contribution">
                    <button class="cancel-btn" id="cancel-btn" data-route="{{ route('st.contribution') }}" type="button">Cancel</button>
                </div>
                @endif
    ...
    @endforeach
    <section id="comment-contribution-wrapper" class="comment-contribution-wrapper">
        <div class="comment-contribution-wrap" >
            ...
            <div class="commentBox-wrap">
                <form action="{{ route('student.comment')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <input type="hidden" name="contribution_id" value="{{ $contribution->id }}">
