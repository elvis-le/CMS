            ...
            <div class="row">
                <div class="col-12">
                    <div class="_head_01">
                        ...
                        <p>List of Course<i class="fas fa-angle-right"></i><span>Contributions</span></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="featured-box">
                        <div class="feature-card">
                            <a href="GraphicandDigitalDesign.blade.php"><i class="far fa-link"></i></a>
                        ...
                        <div class="content">
                            ...
                            <p>Student of contribution experience when study in Greenwich</p>

                            <a>New Update: </a> <a id="currentDate"> </a>
                            <p>Contributed: 189</p>
