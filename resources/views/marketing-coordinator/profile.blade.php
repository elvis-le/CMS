...
<div class="container">
    <aside>
        ...
        <div class="sidebar">
            ...
            <a href="{{ route('mc.profile') }}" class="active">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="profile-form-wrapper">
                        <form class="profile-form-wrap" action="{{ route('mc.profile-save') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('patch')
                        ...
                        <div class="personal-information-wrap">
                            ...
                            <div class="personal-information-body">
                                ...
                                <div class="personal-information">
                                    ...
                                    <input type="text" id="faculty" name="faculty" value="{{ $faculty->faculty }}" disabled>
                                </div>
                                <div class="personal-information">
