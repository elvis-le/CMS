    ...
    <section class="list-file-contribution-wrapper">
        ...
        <form action="" method="post" enctype="multipart/form-data" class="edit-contribution-btn" id="contribution-form">
            ...
            <div class="btn-contribution">
                <button class="cancel-btn" type="button" style="margin-right: .5rem; margin-left: 0;">Cancel</button>
                <button class="approved-btn" id="approved-btn" style="margin-right: .5rem;">Approved</button>
                <button class="rejected-btn" id="rejected-btn">Rejected</button>
            </div>
        </form>
    </section>
