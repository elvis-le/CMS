...
<div class="container">
    ...
    <section class="mc-form form-i-main">
        <div class="mc-form-name form-main">
            <h2 class="form-name">Add Marketing Coordinator</h2>
        </div>
        <form class="form-information-wrapper" action="{{ route('mc.save') }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('patch')
            <div class="form-information-wrap">
                <label for="name-mc">Name</label>
                <input id="name-mc" type="text" placeholder="Name" name="name">
            </div>
            <div class="form-information-wrap">
                <label for="email-mc">Email</label>
                <input id="email-mc" type="text" placeholder="Email" name="email">
            </div>
            <div class="form-information-wrap">
                <label for="phone-mc">Phone</label>
                <input id="phone-mc" type="text" placeholder="Phone" name="phone">
            </div>
            ...
            <div class="form-information-wrap">
                ...
                <select name="faculty">
                    @foreach($faculty as $info)
                        <option value="{{ $info->id }}">{{ $info->faculty }}</option>
                    @endforeach
                </select>
            </div>
