...
<div class="container" style="overflow-y: auto;">
    ...
    <section class="academic-year-form form-i-main">
        <div class="academic-year-form-name form-main">
            <h2 class="form-name">Edit Academic Year</h2>
        </div>
        <form class="form-information-wrapper" action="{{ route('academic.edit-save') }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('patch')
            <input type="hidden" name="id" value="{{ $academicYear->id }}">
            <div class="form-information-wrap">
                <label for="name-academic-year">Name</label>
                <input id="name-academic-year" type="text" value="{{ $academicYear->name }}" name="name">
            </div>
            <div class="form-information-wrap">
                <label>Image</label>
                <label for="img-academic-year"><img class="image" src="{{ $academicYear->image }}" alt="Magazine Image"></label>
            ...
            <div class="form-information-wrap">
                ...
                <input id="startDate-academic-year" type="date" value="{{ $academicYear->startDate }}"  name="startDate">
            </div>
            <div class="form-information-wrap">
                <label for="deadline-academic-year">Deadline</label>
                <input id="deadline-academic-year" type="date" value="{{ $academicYear->deadline }}"  name="deadline">
            </div>
            <div class="form-information-wrap">
                <label for="deadline-academic-year">Final Deadline</label>
                <input id="finalDeadline-academic-year" type="date" value="{{ $academicYear->finalDeadline }}"  name="finalDeadline">
            </div>
