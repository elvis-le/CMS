...
<div class="container">
    ...
    <section class="mc-form form-i-main">
        ...
        <form class="form-information-wrapper" action="{{ route('faculty.save') }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('patch')
            <div class="form-information-wrap">
                <label for="name-faculty">Name</label>
                <input id="name-faculty" type="text" placeholder="Name" name="faculty">
            </div>
