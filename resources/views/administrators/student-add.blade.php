...
<div class="container">
    ...
    <section class="student-form form-i-main">
        <div class="student-form-name form-main">
            <h2 class="form-name">Add Student</h2>
        </div>
        <form class="form-information-wrapper" action="{{ route('user.save') }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('patch')
            <div class="form-information-wrap">
                <label for="name-student">Name</label>
                <input id="name-student" type="text" placeholder="Name" name="name">
            </div>
            <div class="form-information-wrap">
                <label for="email-student">Email</label>
                <input id="email-student" type="text" placeholder="Email" name="email">
            </div>
            <div class="form-information-wrap">
                <label for="phone-student">Phone</label>
                <input id="phone-student" type="text" placeholder="Phone" name="phone">
            </div>
