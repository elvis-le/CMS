...
<div class="container">
    ...
    <section class="student-form form-i-main">
        <div class="student-form-name form-main">
            <h2 class="form-name">Add Guest</h2>
        </div>
        <form class="form-information-wrapper" action="{{ route('guest.save') }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('patch')
            <div class="form-information-wrap">
                <label for="name-guest">Name</label>
                <input id="name-guest" type="text" placeholder="Name" name="name">
            </div>
            <div class="form-information-wrap">
                <label for="email-guest">Email</label>
                <input id="email-guest" type="text" placeholder="Email" name="email">
            </div>
            <div class="form-information-wrap">
            ...
            <input type="hidden" name="roles_id" value="5">
            <div class="form-information-wrap">
