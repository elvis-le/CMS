                                ...
                                <nav class="nav-function">
                                    ...
                                    <div class="list-function">
                                        <li class="function-item">
                                            <form action="{{ route('guest.edit')}}" method="post" enctype="multipart/form-data">
                                                @csrf
                                        ...
                                        <li class="function-item">
                                            <form action="{{ route('guest.delete') }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <input type="hidden" name="id" value="{{ $info->id }}">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        searchBar.addEventListener("input", function() {
            ...
            tableRows.forEach(function(row) {
                ...
                const faculty_id = row.querySelectorAll(".table-body")[2].textContent.toLowerCase();

                if (name.includes(searchText) || email.includes(searchText) || faculty_id.includes(searchText)) {
