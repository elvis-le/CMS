...
class EmailOthersRejectedContribution extends Mailable
{
    ...
    {
        return new Content(
            view: 'emails.other-rejected-notification',
            with: [
                'marketingCoordinatorsName' => $this->marketing_coordinator->name,
                'mcName' => $this->mc->name,
